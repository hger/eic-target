...
spec:
  image: {{ with (coalesce .Values.global.imageRegistry .Values.policyServer.image.registry) }}{{ . }}/{{ end }}{{ .Values.policyServer.image.repository }}:{{ .Values.policyServer.image.tag }}
